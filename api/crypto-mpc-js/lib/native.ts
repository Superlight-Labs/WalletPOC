...
const mpc = ffi.Library(path.join(__dirname, "..", "..", "..", "crypto-mpc-js", "deps", "MPCCrypto" + config.mpcArch), {
  // Memory management
  ...
  MPCCrypto_initEddsaSign: [
    ref.types.int,
    [ref.types.int, VoidPtr, Uint8Ptr, ref.types.int, ref.types.int, VoidPtrPtr],
  ],
  ...
  MPCCrypto_verifyEcdsaBackupKey: [
    ref.types.int,
    [Uint8Ptr, ref.types.int, Uint8Ptr, ref.types.int, Uint8Ptr, ref.types.int],
  ],
  ...
  MPCCrypto_restoreEcdsaKey: [
    ref.types.int,
    [Uint8Ptr, ref.types.int, Uint8Ptr, ref.types.int, Uint8Ptr, ref.types.int, Uint8Ptr, IntPtr],
  ],
